...
def configure_scrcpy(lang, device_info=None):
    ...
    br_c = get_input("  Choice [1-5] (default: 2): ", ["1","2","3","4","5"], "2")
    bitrate = {"1":"4M","2":"8M","3":"16M","4":"40M"}.get(br_c)
    if bitrate is None: bitrate = get_input("  Enter bitrate (e.g. 10M): ", default="8M")
    ...
    if lang == "id":
        ...
        print("    [5] Full   — Resolusi penuh asli HP, tanpa diperkecil")
    else:
        ...
        print("    [5] Full   — Native phone resolution, no downscaling")
    res_c = get_input("  Choice [1-5] (default: 2): ", ["1","2","3","4","5"], "2")
    resolution = {"1":"720","2":"1080","3":"1440","4":"2160","5":"0"}.get(res_c,"1080")
    log_ok(f"Resolution: {'Full/Native' if resolution=='0' else resolution+'p'}")
